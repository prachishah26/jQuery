(function (global, factory) {
    ...
    function drawContour(ctx, points,color, isClosed) {
    ...
    var DrawFaceLandmarks = /** @class */ (function () {
        ...
        DrawFaceLandmarks.prototype.draw = function (canvasArg) {
            ...
            if (drawLines && this.faceLandmarks instanceof FaceLandmarks68) {
                ...
                ctx.lineWidth = lineWidth;
                drawContour(ctx, this.faceLandmarks.getJawOutline(),"orange");
                drawContour(ctx, this.faceLandmarks.getLeftEyeBrow(),"black");
                drawContour(ctx, this.faceLandmarks.getRightEyeBrow(),"black");
                drawContour(ctx, this.faceLandmarks.getNose(),"blue");
                drawContour(ctx, this.faceLandmarks.getLeftEye(),"white", true);
                drawContour(ctx, this.faceLandmarks.getRightEye(),"white", true);
                drawContour(ctx, this.faceLandmarks.getMouth(),"red", true);
            }
            if (drawPoints) {
